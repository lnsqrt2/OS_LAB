...
public:
    ...
    void setupUi(QWidget *TaskManager)
    {
        ...
        TaskManager->resize(673, 494);
        tabWidget = new QTabWidget(TaskManager);
        tabWidget->setObjectName(QStringLiteral("tabWidget"));
        tabWidget->setGeometry(QRect(13, 82, 601, 351));
        ...
        pc_group->setGeometry(QRect(30, 20, 491, 151));
        ...
        label_cpu_name->setGeometry(QRect(190, 30, 81, 18));
        label_cpu_hz = new QLabel(cpu_group);
        label_cpu_hz->setObjectName(QStringLiteral("label_cpu_hz"));
        label_cpu_hz->setGeometry(QRect(190, 70, 81, 18));
        ...
        label_10->setGeometry(QRect(10, 90, 101, 18));
        ...
        label_mem_total->setGeometry(QRect(110, 90, 81, 18));
        group_swap = new QGroupBox(cpumem_info);
        group_swap->setObjectName(QStringLiteral("group_swap"));
        group_swap->setGeometry(QRect(10, 270, 521, 131));
        ...
        label_15->setGeometry(QRect(10, 90, 101, 18));
        ...
        label_mem_free_2->setGeometry(QRect(520, 40, 81, 18));
        label_22 = new QLabel(TaskManager);
        label_22->setObjectName(QStringLiteral("label_22"));
        label_22->setGeometry(QRect(170, 10, 99, 18));
    ...
    void retranslateUi(QWidget *TaskManager)
    {
        ...
        label_20->setText(QApplication::translate("TaskManager", "\345\275\223\345\211\215\346\227\266\351\227\264\357\274\232", 0));
        label_time->setText(QApplication::translate("TaskManager", "TextLabel", 0));
        ...
        button_off->setText(QApplication::translate("TaskManager", "\345\205\263\346\234\272", 0));
